...
//    public ResponseEntity<ApiResponse<DetalleTSDTO>> buscarDetalleTSIdTicket(@PathVariable TicketsEntity ticket){
//        try{
    ...
    public ResponseEntity<ApiResponse<DetalleTSDTO>> actualizarCampoDetalleTS(@PathVariable Long id, @RequestBody DetalleTSDTO dto){
        try {
            ...
            if (datos != null){
                ...
                ApiResponse<DetalleTSDTO> exito = new ApiResponse<>(true, "Campo del ticket: " + id + ", modificado con exito", dto);
                return ResponseEntity.ok(exito);
            }
